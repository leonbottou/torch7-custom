...
#define TH_GENERIC_FILE "generic/SpatialConvolutionNew.c"
#else

static int nn_(SpatialConvolutionNew_updateOutput)(lua_State *L)
{
...
static int nn_(SpatialConvolutionNew_updateGradInput)(lua_State *L)
{
  THTensor *input = luaT_checkudata(L, 2, torch_Tensor);
...
static int nn_(SpatialConvolutionNew_accGradParameters)(lua_State *L)
{
  THTensor *input = luaT_checkudata(L, 2, torch_Tensor);
  THTensor *gradOutput = luaT_checkudata(L, 3, torch_Tensor);
...
static const struct luaL_Reg nn_(SpatialConvolutionNew__) [] = {
  {"SpatialConvolutionNew_updateOutput", nn_(SpatialConvolutionNew_updateOutput)},
  {"SpatialConvolutionNew_updateGradInput", nn_(SpatialConvolutionNew_updateGradInput)},
  {"SpatialConvolutionNew_accGradParameters", nn_(SpatialConvolutionNew_accGradParameters)},
  {NULL, NULL}
};

static void nn_(SpatialConvolutionNew_init)(lua_State *L)
{
  luaT_pushmetatable(L, torch_Tensor);
  luaT_registeratname(L, nn_(SpatialConvolutionNew__), "nn");
  lua_pop(L,1);
}
